from opparse.parse.nodes import (node_type, node_arity,
                                      node_first, node_second, node_third, node_fourth, node_children, is_empty_node)
from opparse.runtime import error
from opparse.types import space, api, plist, environment, symbol as symbols, string as strings
from opparse.builtins import lang_names

from opparse.parse import nodes


def simplify_error(compiler, code, node, message):
    from opparse.compiler import compile_error
